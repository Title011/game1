...
function updateSandboxButton(){
  ...
  /* เปลี่ยนโหมด = เปลี่ยนเพลง แต่หน้าจอไม่ได้เปลี่ยน ฮุกใน showScreen จึงไม่ทำงาน
     ฝากไว้ที่ฟังก์ชันอัปเดตปุ่มเพราะนี่คือจุดที่ทุกทางเข้า-ออกโหมดผ่านแน่นอน
     (bgmRefresh อ่านสถานะสด ๆ และไม่เริ่มเพลงซ้ำถ้าเพลงเดิมเล่นอยู่แล้ว) */
